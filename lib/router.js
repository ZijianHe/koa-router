...
Router.prototype.routes = Router.prototype.middleware = function () {
  ...
  if (router.stack.middleware.length) {
    return compose(router.stack.middleware.concat(middleware));
  } else {
    return middleware;
  }
};
 ...
 * @param {String} path
 * @returns {Route|false} Returns matched route or false.
 * @private
 */

Router.prototype.match = function (ctx, path) {
  var routes = this.stack.routes;
